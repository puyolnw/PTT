    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          จัดการการตั้งค่าสำหรับร้านขายของใช้ราคาถูกจากญี่ปุ่น (เริ่มต้น 60 บาท) สินค้าหลากหลายกว่า 80,000 รายการ
        </p>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-muted mt-1">
            ระบบจะแจ้งเตือนเมื่อสต็อกสินค้าต่ำกว่า {settings.lowStockThreshold}% ของเกณฑ์ที่กำหนด (สำคัญสำหรับสินค้าหลากหลายกว่า 80,000 รายการ)
          </p>
        </div>
      </motion.div>
