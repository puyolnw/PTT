...
// Mock data สำหรับร้านไดโซ - เน้นการสั่งซื้อจาก Daiso Japan
const initialPurchases = [
  {
    id: "1",
    date: "2024-12-15",
    supplier: "Daiso Japan",
    items: "ของใช้ 1,000 ชิ้น",
    amount: 60000,
    status: "ชำระแล้ว",
    dueDate: "2024-12-15",
    source: "Excel",
...
export default function Purchases() {
  ...
  const handleCreatePO = () => {
    alert("กำลังสร้างใบสั่งซื้อ (PO) สำหรับสั่งสินค้าจาก Daiso Japan...");
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          สร้างใบสั่งซื้อ (PO) สำหรับสั่งสินค้าจาก Daiso Japan หรือซัพพลายเออร์ บันทึกข้อมูลการสั่งซื้อจาก Excel (แอป Daiso) หรือกรอกด้วยมือ
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          ...
          <p className="text-2xl font-bold text-app">
            {purchases.filter((p) => p.source === "Excel").length}
          </p>
          <p className="text-sm text-muted">รายการ</p>
        </motion.div>
      </div>
        ...
        <FilterBar
          ...
          filters={[
            ...
            },
            {
              ...
              options: [
                { value: "", label: "ทั้งหมด" },
                { value: "Excel", label: "Excel (แอป Daiso)" },
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-soft border border-app rounded-lg text-app"
              placeholder="เช่น Daiso Japan, ซัพพลายเออร์ A"
              required
            />
          </div>
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 bg-soft border border-app rounded-lg text-app"
              placeholder="เช่น ของใช้ 1,000 ชิ้น, ของตกแต่ง 500 ชิ้น, ค่าส่งจากญี่ปุ่น"
              rows={3}
              required
            />
          </div>
          ...
          <div>
            ...
            >
              ...
              <option value="Excel">Excel (แอป Daiso)</option>
            </select>
          </div>
        </div>
      </ModalForm>
        ...
        <div className="space-y-4">
          <div className="bg-ptt-blue/10 border border-ptt-blue/30 rounded-xl p-4">
            <p className="text-sm text-muted mb-2">
              สร้างใบสั่งซื้อ (PO) สำหรับสั่งสินค้าจาก Daiso Japan หรือซัพพลายเออร์
            </p>
            <p className="text-xs text-muted">
              ระบบจะสร้าง PO และติดตามสถานะการส่งอัตโนมัติ
            </p>
          </div>
          <div>
            <label className="block text-sm font-medium text-app mb-2">ซัพพลายเออร์</label>
            ...
            >
              <option value="Daiso Japan">Daiso Japan</option>
              <option value="ซัพพลายเออร์ A">ซัพพลายเออร์ A</option>
            </select>
          </div>
          <div>
            <label className="block text-sm font-medium text-app mb-2">รายการสินค้า</label>
