    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        ...
        <div className="flex gap-2">
          <label htmlFor="chester-upload-excel" className="flex items-center gap-2 px-4 py-2 bg-soft text-app rounded-lg hover:bg-app/10 transition-colors cursor-pointer">
            <Upload className="w-4 h-4" />
            <span>นำเข้า Excel จากแอป Chester&apos;s</span>
            <input
              id="chester-upload-excel"
              type="file"
              accept=".xlsx,.xls"
      ...
      >
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="chester-purchase-date" className="block text-sm font-medium text-app mb-2">วันที่</label>
              <input
                id="chester-purchase-date"
                type="date"
                value={formData.date}
            ...
            <div>
              <label htmlFor="chester-purchase-status" className="block text-sm font-medium text-app mb-2">สถานะ</label>
              <select
                id="chester-purchase-status"
          ...
          <div>
            <label htmlFor="chester-purchase-supplier" className="block text-sm font-medium text-app mb-2">ซัพพลายเออร์</label>
            <input
              id="chester-purchase-supplier"
              type="text"
          ...
          <div>
            <label htmlFor="chester-purchase-items" className="block text-sm font-medium text-app mb-2">รายการวัตถุดิบ</label>
            <textarea
              id="chester-purchase-items"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="chester-purchase-amount" className="block text-sm font-medium text-app mb-2">จำนวนเงิน (บาท)</label>
              <input
                id="chester-purchase-amount"
                type="number"
            ...
            {formData.status === "รอชำระ" && (
              <div>
                <label htmlFor="chester-purchase-due-date" className="block text-sm font-medium text-app mb-2">ครบกำหนด</label>
                <input
                  id="chester-purchase-due-date"
                  type="date"
          ...
          <div>
            <label htmlFor="chester-purchase-source" className="block text-sm font-medium text-app mb-2">แหล่งที่มา</label>
            <select
              id="chester-purchase-source"
