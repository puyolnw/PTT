...
export default function Settings() {
  ...
  const [settings, setSettings] = useState({
    ...
    expiryWarningDays: 3, // สำคัญสำหรับวัตถุดิบทะเล
    email: "",
    phone: "",
    address: "",
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          จัดการการตั้งค่าสำหรับร้านอาหารก๋วยเตี๋ยวลูกชิ้นปลา (ผลิตตามมาตรฐาน GMP/HACCP)
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-muted mt-1">
              ระบบจะแจ้งเตือนเมื่อสินค้าเหลืออายุ {settings.expiryWarningDays} วัน (สำคัญสำหรับวัตถุดิบทะเล)
            </p>
          </div>
        </div>
      </motion.div>
