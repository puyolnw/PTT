    ...
    <div className="space-y-6">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="add-product-cost" className="block text-sm font-medium text-app mb-2">ต้นทุน (บาท/{formData.unit})</label>
              <input
                id="add-product-cost"
                type="number"
                value={formData.cost}
            ...
            <div>
              <label htmlFor="add-product-price" className="block text-sm font-medium text-app mb-2">ราคาขาย (บาท/{formData.unit})</label>
              <input
          ...
          <div>
            <label htmlFor="add-product-brand" className="block text-sm font-medium text-app mb-2">แบรนด์</label>
            <input
          ...
          <div>
            <label htmlFor="add-product-expiry" className="block text-sm font-medium text-app mb-2">วันหมดอายุ (สำหรับแบตเตอรี่/อะไหล่)</label>
            <input
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="edit-product-cost" className="block text-sm font-medium text-app mb-2">ต้นทุน (บาท/{formData.unit})</label>
              <input
            ...
            <div>
              <label htmlFor="edit-product-price" className="block text-sm font-medium text-app mb-2">ราคาขาย (บาท/{formData.unit})</label>
              <input
          ...
          <div>
            <label htmlFor="edit-product-brand" className="block text-sm font-medium text-app mb-2">แบรนด์</label>
            <input
