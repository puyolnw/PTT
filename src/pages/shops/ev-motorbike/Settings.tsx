...
import { Settings as SettingsIcon, Save, Store, Link as LinkIcon, Zap, Battery } from "lucide-react";
...
export default function Settings() {
  ...
  const [settings, setSettings] = useState({
    ...
    phone: "",
    address: "",
    connectToModule1: true, // เชื่อมต่อโมดูล M1 (ชาร์จ EV กับระบบปั๊ม)
    connectToModule6: true, // เชื่อมต่อโมดูล M6 (ค่าเช่า)
    connectToModule7: true, // เชื่อมต่อโมดูล M7 (แดชบอร์ดรวม)
    evChargingPoints: "20+", // จุดชาร์จ PTT (20+ จุดในปี 2025)
    brands: ["SKY Motorbike", "SAGASONIC", "Sabaie Bike"],
  });
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          จัดการการตั้งค่าสำหรับร้านขายและบริการมอเตอร์ไซค์ไฟฟ้า จักรยานไฟฟ้า สกู๊ตเตอร์ไฟฟ้า สามล้อไฟฟ้า (SKY Motorbike, SAGASONIC, Sabaie Bike) ราคาเริ่มต้น 20,000-50,000 บาท มีบริการชาร์จ EV ที่ปั๊ม PTT รองรับผ่อน 0% 12 เดือน
        </p>
      </motion.div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-soft border border-app rounded-lg text-app"
              placeholder="เช่น สาขาท่าขอนยาง มหาสารคาม"
            />
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs text-muted mt-1">
              ระบบจะแจ้งเตือนเมื่อสต็อกต่ำกว่า {settings.lowStockThreshold}% ของเกณฑ์ที่กำหนด (สำคัญสำหรับแบตเตอรี่/อะไหล่ EV)
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-app">การตั้งค่าการเงิน</h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            />
            <p className="text-xs text-muted mt-1">
              ค่าเช่าจะถูกส่งไปยังโมดูล M6 อัตโนมัติ (ค่าเช่าร้าน EV → รายได้ประจำเดือน + VAT)
            </p>
          </div>
        </div>
      </motion.div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl border border-app">
            <div className="flex items-center gap-3">
              <Zap className="w-5 h-5 text-ptt-cyan" />
              <div>
                <p className="font-medium text-app">M1: เชื่อมชาร์จ EV กับระบบปั๊ม</p>
                <p className="text-sm text-muted">
                  เชื่อมจุดชาร์จ PTT ({settings.evChargingPoints} จุดในปี 2025) สำหรับลูกค้า
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl border border-app">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-app">M6: บันทึกค่าเช่าเป็นรายได้</p>
                <p className="text-sm text-muted">
                  ค่าเช่าร้าน EV → รายได้ประจำเดือน + VAT
                </p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
