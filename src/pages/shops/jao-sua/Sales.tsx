    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        ...
        <div className="flex gap-2">
          <label htmlFor="jao-sua-sales-upload-stock" className="flex items-center gap-2 px-4 py-2 bg-soft text-app rounded-lg hover:bg-app/10 transition-colors cursor-pointer">
            <Upload className="w-4 h-4" />
            <span>นำเข้าจาก Stock Program</span>
            <input
              id="jao-sua-sales-upload-stock"
              type="file"
              accept=".xlsx,.xls"
      ...
      >
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="jao-sua-sales-date" className="block text-sm font-medium text-app mb-2">วันที่</label>
              <input
                id="jao-sua-sales-date"
                type="date"
                value={formData.date}
            ...
            <div>
              <label htmlFor="jao-sua-sales-payment" className="block text-sm font-medium text-app mb-2">วิธีชำระ</label>
              <select
                id="jao-sua-sales-payment"
          ...
          <div>
            <label htmlFor="jao-sua-sales-customer" className="block text-sm font-medium text-app mb-2">ลูกค้า (ไม่บังคับ)</label>
            <input
              id="jao-sua-sales-customer"
              type="text"
