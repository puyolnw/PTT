...
// Mock data - OCR Scan สำหรับร้านเจ้าสัว (บิลขาย/ค่าใช้จ่าย)
const mockOCRScans = [
  {
    id: "OCR-JAOSUA-001",
    fileName: "บิลขาย_ติ่มซำ_2024-12-15.jpg",
    ...
    extractedData: {
      ...
      total: 2500,
      items: [
        { name: "ติ่มซำชุดใหญ่", quantity: 2, price: 150, total: 300 },
        { name: "ข้าวตังหน้าหมูหยอง", quantity: 5, price: 80, total: 400 },
        { name: "หมูหยอง", quantity: 3, price: 200, total: 600 },
      ],
  ...
  {
    id: "OCR-JAOSUA-003",
    fileName: "บิลซื้อวัตถุดิบ_โรงงานโคราช.jpg",
