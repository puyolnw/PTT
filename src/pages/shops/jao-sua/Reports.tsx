...
const topSellingItems = [
  { name: "ข้าวตังหน้าหมูหยอง", sales: 240000, cost: 144000, profit: 96000, menu: "ของฝาก", trend: "+20%" },
  { name: "ติ่มซำชุดใหญ่", sales: 450000, cost: 270000, profit: 180000, menu: "ติ่มซำ", trend: "+15%" },
  { name: "หมูหยอง", sales: 180000, cost: 108000, profit: 72000, menu: "ของฝาก", trend: "+25%" },
  { name: "ติ่มซำรสพิเศษ", sales: 120000, cost: 72000, profit: 48000, menu: "ติ่มซำ", trend: "+10%" },
];

// Purchase planning data
const purchasePlanning = [
  { item: "ข้าวตัง", currentStock: 200, threshold: 500, recommended: 500, unit: "ถุง", reason: "สต็อกต่ำกว่าเกณฑ์ (เหลือ 40%)" },
  { item: "หมูหยอง", currentStock: 500, threshold: 1000, recommended: 1000, unit: "กรัม", reason: "สต็อกต่ำกว่าเกณฑ์ (เหลือ 50%)" },
  { item: "แป้งติ่มซำ", currentStock: 50, threshold: 100, recommended: 100, unit: "กก.", reason: "สต็อกต่ำและใกล้หมดอายุ" },
];
...
export default function Reports() {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted font-light">
              รายงานกำไร-ขาดทุน รายงานการซื้อ รายงานสต็อก และรายงานยอดขาย แยกตามสาขา/เมนู (ติ่มซำ vs ของฝาก) การวางแผนการสั่งซื้อ
            </p>
          </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-app">เมนูขายดี (ฮิต: ข้าวตังหมูหยอง)</h3>
