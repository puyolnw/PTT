...
const mockSalesData = {
  ...
  lastMonth: 800000,
  byService: {
    oilChange: { amount: 21000, percentage: 70, name: "เปลี่ยนน้ำมันเครื่อง" },
    tireRepair: { amount: 6000, percentage: 20, name: "ซ่อมยาง" },
    inspection: { amount: 2000, percentage: 7, name: "ตรวจสภาพรถ" },
    others: { amount: 1000, percentage: 3, name: "อื่นๆ" },
  },
};

const mockStockData = [
  { name: "น้ำมันเครื่อง PTT", quantity: 20, unit: "ลิตร", lowStock: true, expiry: "2025-12-31", category: "อะไหล่" },
  { name: "ไส้กรองอากาศ", quantity: 15, unit: "ชิ้น", lowStock: true, expiry: "2026-01-15", category: "อะไหล่" },
  { name: "ไส้กรองน้ำมันเครื่อง", quantity: 30, unit: "ชิ้น", lowStock: false, expiry: "2026-02-01", category: "อะไหล่" },
  { name: "ยางรถยนต์", quantity: 8, unit: "เส้น", lowStock: true, expiry: "2027-01-10", category: "อะไหล่" },
  { name: "น้ำมันเกียร์", quantity: 50, unit: "ลิตร", lowStock: false, expiry: "2025-12-31", category: "อะไหล่" },
];
...
const mockRecentPurchases = [
  { id: "1", supplier: "PTT", item: "น้ำมันเครื่อง PTT 100 ลิตร", amount: 50000, date: "2024-12-15", status: "ชำระแล้ว", source: "Stock Program" },
  { id: "2", supplier: "PTT", item: "ค่าน้ำ/ไฟ", amount: 3000, date: "2024-12-10", status: "ชำระแล้ว", source: "Manual" },
  { id: "3", supplier: "ซัพพลายเออร์ A", item: "ยางรถยนต์ 10 เส้น", amount: 35000, date: "2024-12-08", status: "รอชำระ", source: "Stock Program" },
];

const mockTopSellingServices = [
  { name: "เปลี่ยนน้ำมันเครื่อง PTT Lubricants", sales: 630000, quantity: 300, trend: "+15%", service: "เปลี่ยนน้ำมันเครื่อง" },
  { name: "ซ่อมยาง", sales: 180000, quantity: 90, trend: "+8%", service: "ซ่อมยาง" },
  { name: "ตรวจสภาพรถ", sales: 60000, quantity: 30, trend: "+25%", service: "ตรวจสภาพรถ" },
  { name: "บริการ EV", sales: 30000, quantity: 5, trend: "+50%", service: "อื่นๆ" },
];

export default function FitAutoDashboard() {
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          ภาพรวมยอดขาย สต็อกอะไหล่ และการเงินของศูนย์บริการรถยนต์ครบวงจร (ซ่อมบำรุง, เปลี่ยนน้ำมันเครื่อง PTT Lubricants, ตรวจสภาพรถ, บริการ EV)
        </p>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-muted">ยอดขายวันนี้ (เปลี่ยนน้ำมัน 70%)</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4">
            <p className="text-sm text-muted mb-1">{mockSalesData.byService.tireRepair.name}</p>
            <p className="text-2xl font-bold text-blue-400">
              {currencyFormatter.format(mockSalesData.byService.tireRepair.amount)}
            </p>
            <p className="text-xs text-muted mt-1">
              {mockSalesData.byService.tireRepair.percentage}% ของยอดขาย
            </p>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-muted">สต็อกคงเหลือและสถานะ (น้ำมันเครื่อง, ไส้กรอง)</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-muted">ยอดขายรายเดือน (ฮิต: เปลี่ยนน้ำมัน PTT Lubricants)</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-muted">รายการล่าสุด (จาก PTT)</p>
            </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <button className="flex items-center gap-3 p-4 bg-green-500/10 hover:bg-green-500/20 border border-green-500/30 rounded-xl transition-colors">
            ...
            <span className="text-app font-medium">บริการ EV</span>
          </button>
        </div>
      </motion.div>
    </div>
