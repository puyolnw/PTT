...
// Mock data สำหรับ FIT Auto - เน้นอะไหล่จาก PTT
const initialPurchases = [
  {
    id: "1",
    date: "2024-12-15",
    supplier: "PTT",
    items: "น้ำมันเครื่อง PTT 100 ลิตร",
    amount: 50000,
    status: "ชำระแล้ว",
    dueDate: "2024-12-15",
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          บันทึกการซื้ออะไหล่ (น้ำมันเครื่อง PTT, ยางรถ) จากซัพพลายเออร์ (เช่น PTT) นำเข้าจาก Stock Program หรือกรอกด้วยมือ
        </p>
      </motion.div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2 bg-soft border border-app rounded-lg text-app"
              placeholder="เช่น น้ำมันเครื่อง PTT 100 ลิตร, ยางรถยนต์ 10 เส้น"
              rows={3}
              required
            />
          </div>
