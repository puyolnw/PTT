    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted font-light">
          จัดการการตั้งค่าสำหรับร้านสะดวกซื้อ 7-Eleven
        </p>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-muted mt-1">
            ค่าเช่านี้จะถูกบันทึกเป็นรายได้ในโมดูล M6 อัตโนมัติ
          </p>
        </div>
      </motion.div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl border border-app">
            <div>
              ...
              <p className="text-sm text-muted">
                ค่าเช่า 7-Eleven จะถูกบันทึกเป็นรายได้ประจำเดือนอัตโนมัติ
              </p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-soft rounded-xl border border-app">
            <div>
              ...
              <p className="text-sm text-muted">
                ข้อมูลยอดขายและกำไรจะแสดงในแดชบอร์ดรวมอัตโนมัติ
              </p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
