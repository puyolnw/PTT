...
const mockBalanceRows: BalanceRow[] = [
  ...
  // เพิ่มข้อมูลรายวัน (ตัวอย่าง) ให้มีจำนวนมากขึ้น
  {
    date: "23/5/68",
    fullDate: new Date(2025, 4, 23),
    receive: 305200,
    pay: 410450.75,
    balance: 2052054.09,
    pumps: {
