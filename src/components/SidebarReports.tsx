...
export default function SidebarReports({ onClose, isMobile = false, isExpanded = true }: SidebarReportsProps) {
        ...
        <div className={`flex items-center gap-3 ${showText ? 'flex-1' : ''}`}>
          ...
          {showText && (
            <div className="overflow-hidden">
              <h2 className="text-lg font-semibold text-[var(--accent)] font-display whitespace-nowrap">รายงานและสถิติ</h2>
              <p className="text-xs text-muted font-light whitespace-nowrap">วิเคราะห์ข้อมูล</p>
            </div>
          )}
        </div>
